...
/**
 * SC-6: cart poll recovery — tab on /cart/no-checkout, monitor keys productUrl, recovery on invisible-atc.
 * Parity with FIX-3 sc6-poll-recovery-rearm on /cart/no-checkout (fixture-e2e has browser coverage).
 */
