...
export const JOURNEYS = {
  ...
  'FIX-3': {
    id: 'FIX-3',
    retailer: 'core',
    summary: 'Fixture e2e asserts journey invariants offline (WM-2/SC-5 no sacred lock, WM-4/WM-5/WM-6 sacred lock + error paths, SC-6 NAV_FAILED, TGT-4 manual review)',
