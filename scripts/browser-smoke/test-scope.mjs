...
export const JOURNEYS = {
  ...
  'SC-6': {
    ...
    coverage: 'strong',
    tests: ['samsclub-module-simulation.mjs', 'fixture-e2e.mjs'],
  },
  'FIX-1': {
    id: 'FIX-1',
    retailer: 'core',
