...
export const JOURNEYS = {
  ...
  'SC-1': {
    id: 'SC-1',
    retailer: 'samsclub',
    summary: "Sam's Club retailer module registered in manifest",
    impl: ['target-checkout-helper/manifest.json', 'target-checkout-helper/samsclub-content.js'],
    coverage: 'missing',
    tests: [],
  },
  'SC-3': {
  ...
  'SC-6': {
    ...
    impl: ['target-checkout-helper/samsclub-content.js', 'target-checkout-helper/background.js'],
    coverage: 'missing',
    tests: [],
  },
};
...
export const EXTENSION_SUITE = {
  ...
  'extension-functional.mjs': ['MON-1', 'MON-3', 'TGT-1', 'TGT-2'],
